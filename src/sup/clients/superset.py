...
class SupSupersetClient:
    ...
    def get_themes(
        ...
        Pass ``single_page=True`` to fetch only the one requested page.
        """
        import prison
        ...
        while True:
            ...
            # when we already have enough results to satisfy the limit,
            # or when the caller requested only this single page.
